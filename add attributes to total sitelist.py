...
landuse_path = "D:/Dian/Data/Land_Use/nlcd_2011_landcover_2011_edition_2014_10_10/"
tmp_path = "D:/arcgis/tmp/"
out_path = "D:/Dian/Spatial_Image/Add_attributes_to_total_sitelist/"
mask_path = "D:/Dian/Data/United_States_2000/background/"
arcpy.env.overwriteOutput = True

site = "sitelist"

in_table = ozone_path + site + ".csv"
x_coords = "longitude"
y_coords = "latitude"
out_layer = "event" + ".shp"
...
inRasters2 = "D:/Dian/Spatial_Image/Night_Image/F16_20100111-20110731_rad_v4.geotiff/F16_20100111-20110731_rad_v4.avg_vis.tif"
inPoints = out_path+"event"+".shp"
inRasters3 = landuse_path + "nlcd_2011_landcover_2011_edition_2014_10_10.img"
ExtractMultiValuesToPoints(inPoints, [inRasters1], "BILINEAR")
ExtractMultiValuesToPoints(inPoints, [inRasters2], "BILINEAR")
...
sites = out_path + "event" + ".shp"
arcpy.Clip_analysis(sites, urban_polygon, urban_sites)

clean_input = clean_path + "CASTMEAN_2014" + ".shp"
...
inFeatures = [urban_sites, clean_sites, rural_sites]
outFeatures = out_path + "Sitelist_new" + ".shp"
...
with open(csv_fn, 'wb') as csvfile:
    ...
    in_db.close()
    print "Done with get urban rural clean"
